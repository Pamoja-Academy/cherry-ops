...
- Team wallpaper PNGs currently ship with baked face-glitch bars — never default the login hero to the group shot; start on clean individual locked heroes; group shot last/optional only until a clean composite exists.
