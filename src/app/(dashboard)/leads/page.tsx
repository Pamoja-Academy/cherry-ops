    ...
    <div className="space-y-4">
      ...
      >
        <div className="relative z-10">
          ...
          <p className="text-white/70 text-sm mt-1">Growing our private-sector client base</p>
          ...
          return (
            <div key={stage} className="flex-shrink-0 w-56">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-semibold px-1.5 py-0.5 rounded-full ml-auto" style={{ background: `${color}20`, color }}>
                  {stageLeads.length}
                </span>
              </div>
